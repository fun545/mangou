<template>
  <div class="order-enter-view">
    ...
    <div class="flex-box enter-box">
      ...
      <div class="enter-order" @click="enterOrder">确认下单</div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default{
    ...
    methods: {
      enterOrder () {
        this.$vux.alert.show({content: '订单提交成功'})
      }
    }
  }
</script>
...
<style lang="less">
  ...
  .order-enter-view .content-view-scroller {
